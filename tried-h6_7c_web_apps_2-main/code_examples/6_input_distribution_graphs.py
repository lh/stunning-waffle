...
#####################################################
# Inter-arrival time distribution - slider and plot #
#####################################################
...
############################################################
# Patient Constulation time distribution - slider and plot #
############################################################
...
consult_fig.update_xaxes(tick0=0,
                     dtick=10,
                     range=[0, 240])
consult_fig.layout.update(showlegend=False,
                      margin=dict(l=0, r=0, t=0, b=0))
st.markdown("#### Consultation Time Distribution")
st.plotly_chart(consult_fig,
                use_container_width=True,
                config = {'displayModeBar': False})
