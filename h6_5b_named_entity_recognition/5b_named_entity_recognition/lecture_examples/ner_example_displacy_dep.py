...
# Split into sentences before rendering with displacy for easier
# interpretability, then render syntactic dependencies and POS tags
sentences = list(doc.sents)
spacy.displacy.render(sentences, style="dep")
