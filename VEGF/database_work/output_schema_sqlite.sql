...
CREATE TABLE [activitybinary] (
    ...
    [abn_editablestate] TEXT NOT NULL,
...
CREATE TABLE [clinicalconceptgroup] (
    ...
    [ccg_formatString] TEXT NOT NULL,
...
CREATE TABLE [Data] (
    ...
    [dtd_data] varbinary(max) NOT NULL,
    [sdd_data] varbinary(max) NOT NULL,
    [sdd_mappedData] TEXT,
    [sdd_humanReadableData] TEXT,
...
CREATE TABLE [EncounterTemplate] (
    ...
    [aet_Icon] varbinary(max) NOT NULL,
...
CREATE TABLE [LateralisedRiskFactors] (
    ...
    [plf_PreviousSurgeryProceduresDescription] TEXT,
    [plf_PreviousSurgeryOperativeComplicationsDescription] TEXT
);
...
CREATE TABLE [MergeField] (
    ...
    [smf_DocumentComponentDescription] TEXT NOT NULL,
    [smf_FullFriendlyName] TEXT
);
...
CREATE TABLE [Message] (
    ...
    [bmg_MessageContent] varbinary(max),
...
CREATE TABLE [OutboundMessage] (
    ...
    [hom_MessageContent] varbinary(max),
...
CREATE TABLE [PatientMerge] (
    ...
    [opm_OphthalSuiteMergeError] TEXT
);
...
CREATE TABLE [PendingPackage] (
    ...
    [epp_PackageArtefactDefinitionPayload] TEXT NOT NULL
);
...
CREATE TABLE [templateblock] (
    ...
    [tbk_contents] varbinary(max) NOT NULL,
