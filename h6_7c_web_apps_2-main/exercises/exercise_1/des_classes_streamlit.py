...
class g:
    # Inter-arrival times
    patient_inter = patient_inter_slider
    
    call_inter = call_inter_slider

    # Activity times
    mean_reg_time = mean_reg_time_slider
    mean_gp_time = mean_gp_time_slider
    mean_book_test_time = mean_book_test_time_slider
    mean_call_time = mean_call_time_slider

    # Resource numbers
    number_of_receptionists = number_of_receptionists_slider
    number_of_gps = number_of_gps_slider

    # Branch probabilities
    prob_book_test = prob_book_test_slider

    # Simulation meta parameters
    sim_duration = sim_duration_slider
    number_of_runs = 10
