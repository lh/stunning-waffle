...
closer = closest(computer_try, user_try, actual_duration)

print(f"It took {actual_duration} seconds.")
print(f"You chose {user_try}; I chose {computer_try}")
print(f"The actual time was {actual_duration} so {closer} was nearest")
