...
# Display current maxUploadSize configuration
max_upload_size = st.config.get_option("server.maxUploadSize")
st.write(f"Current maxUploadSize: {max_upload_size} MB")
