...
def agent_portrayal(agent):
    ...
    # color = "tab:grey"
    outlierness = getattr(agent, 'outlierness', 0)
    
    color = (agent.love_hsma_score, 1-agent.love_hsma_score, 0, 1 - outlierness)
...
page = JupyterViz(
    Persuasion_Model,
    model_params,
    measures=["Total Loving HSMA", "Total Hating HSMAx"],
